...
void Urgent_entry(ULONG thread_input)
{
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "Urgent Thread: Some important event",
                                TX_POINTER_TO_ULONG_CONVERT(&Urgent), 0, 0, TX_TRACE_ID_EVENTS);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "Current Time: %5lu    Urgent Thread finished a cycle...\n",
               current_time);
...
void Routine_entry(ULONG thread_input)
{
    ...
    while (1)
    {
     ...
     //   printf("Routine Thread: Additional activity\n");
        ...
        current_time = tx_time_get();
         TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "Routine Thread: Some important event",
                                TX_POINTER_TO_ULONG_CONVERT(&Routine), 0, 0, TX_TRACE_ID_EVENTS);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "Current Time: %5lu    Routine Thread finished a cycle...\n",  current_time);
    //fprintf(trace_file, "Printed2");
    fflush(trace_file);  // Flush the buffer       
...
TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "High Priority Thread: Additional activity",
                                TX_POINTER_TO_ULONG_CONVERT(&High), 0, 0, TX_TRACE_ID_EVENTS);

        printf("id:%lu High Priority Thread: Additional activity\n Current Time: %5lu", task_id, current_time);
        tx_thread_sleep(8);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "id:%lu High Priority Thread: Additional activity\n Current Time: %5lu", task_id, current_time);
    //fprintf(trace_file, "Printed2");
    fflush(trace_file);  // Flush the buffer     
    }
}
...
TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "Medium Priority Thread: Additional activity",
                                TX_POINTER_TO_ULONG_CONVERT(&threads[1]), 0, 0, TX_TRACE_ID_EVENTS);

    printf("id:%lu Medium Priority Thread: Additional activity after 10000 tasks\n Current Time: %5lu", task_id, current_time);
        tx_thread_sleep(9);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "id:%lu Medium Priority Thread: Additional activity after 10000 tasks\n Current Time: %5lu", task_id, current_time);
    //fprintf(trace_file, "Printed2");
    fflush(trace_file);  // Flush the buffer     
...
void low_priority_thread_entry(ULONG param)
{
 ...
 TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "Low Priority Thread: Additional activity",
                                TX_POINTER_TO_ULONG_CONVERT(&threads[2]), 0, 0, TX_TRACE_ID_EVENTS);

        // Additional activities for Low Priority thread
        printf("id:%lu Low Priority Thread: Additional activity\n Current Time: %5lu", task_id, current_time);
        tx_thread_sleep(6);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "id:%lu Low Priority Thread: Additional activity\n Current Time: %5lu", task_id, current_time);
    //fprintf(trace_file, "Printed2");
    fflush(trace_file);  // Flush the buffer 
...
void other_threads_entry(ULONG param)
{
     ...
     while (task_id <= 10)  // Stop at 10
    {
        ...
        TX_TRACE_IN_LINE_INSERT(TX_TRACE_EVENT_ID_STRING, "Other Threads: Additional activity",
                                TX_POINTER_TO_ULONG_CONVERT(&threads[3]), 0, 0, TX_TRACE_ID_EVENTS);
 
        // Additional activities for Other Threads
        printf("id:%lu Other Threads: Additional activity\n Current Time: %5lu", task_id, current_time);
        tx_thread_sleep(5);
...
if (trace_file == NULL) {
   ...
   // return 1;
    ...
    fprintf(trace_file, "id:%lu Other Threads: Additional activity\n Current Time: %5lu", task_id, current_time);
    //fprintf(trace_file, "Printed2");
    fflush(trace_file);  // Flush the buffer 
